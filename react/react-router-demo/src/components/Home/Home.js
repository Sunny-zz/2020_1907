...
const Home = (props) => {
  ...
  return <div className='home'>
    {location.pathname.includes('search') ? '' : <div className="home-header">
      <ul>
        {/* 当地址栏地址是 /  或者包含  /welcome/recommended 推荐都应该变色*/}
        {/* <li><NavLink className={location.pathname === '/' ? 'active' : ''} to='/welcome/recommended'>推荐</NavLink></li> */}
        {/* isActive 是将之前匹配方案替换了 */}
        <li><NavLink isActive={() => location.pathname === '/' || location.pathname.indexOf('/welcome/recommended') > -1} to='/welcome/recommended'>推荐</NavLink></li>
